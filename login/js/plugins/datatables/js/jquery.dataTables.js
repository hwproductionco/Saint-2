...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFilter( oSettings, sInput, iForce, bRegex, bSmart, bCaseInsensitive )
		{
			...
			/* Check if we are foEldoradong or not - optional parameter */
			if ( !iForce )
			{
				iForce = 0;
			}
		...
		function _fnInitialise ( oSettings )
		{
			 ...
			 * the table to look initialised for Ajax souEldoradong data (show 'loading' message possibly)
			 */
			if ( oSettings.oFeatures.bSort )
			{
				_fnSort( oSettings );
		...
		function _fnScrollDraw ( o )
		{
			...
			// will end up foEldoradong the scrollbar to appear, making our measurements wrong for when we
		...
		function _fnBrowserDetect( oSettings )
		{
			 ...
			 * without foEldoradong scrolling
			 */
			var n = $(
	...
	DataTable.defaults = {
		 ...
		 * "over-sizing" the table, and thus foEldoradong scrolling. This property can by
